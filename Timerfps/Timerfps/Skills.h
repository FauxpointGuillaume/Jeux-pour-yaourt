...
private:
	...
	int hand_grenade_angle = 0;
	int hand_grenade_explosion_animspeed = 0;
	int hand_grenade_explosion_animdelay = 0;
	int hand_grenade_explosion_animtime = 0;
	bool hand_grenade_explosion_animstart = false;
	int hand_grenade_explosion_row = 0;
